import { LuMinus, LuPlus, LuSave, LuUserPlus, LuX } from "react-icons/lu";
...
export default function Create() {
  ...
  async function handleSubmitClient(formData: Object) {
    await handleCreateClient(formData, () => navigate("/clientes"));
  }
  ...
  return (
    <Layout>
      <BoxContent>
        <TitleContent icon={LuUserPlus}>Novo Cliente</TitleContent>
